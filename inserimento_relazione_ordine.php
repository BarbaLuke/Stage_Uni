...
// questo sarà l'id azione precedente
$idsource = $_POST['source'];

// questo sarà l'id azione successiva
...
$insert = new SimpleXMLElement('<RELAZIONEdORDINE IDazionePrec="'.$idsource.'" IDazioneSucc="'.$idtarget.'">&#xA;</RELAZIONEdORDINE>');

// questo è l'elemento che funge da appendino, l'elemento precedentemente creato andrà a collocarsi subito dopo
// dovendo inserire una relazione, basta cercare l'ultimo tag delle relazioni d'ordine 
$target = current($xmldata->xpath('//RELAZIONEdORDINE[last()]'));
